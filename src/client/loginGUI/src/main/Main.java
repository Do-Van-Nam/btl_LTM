package client.loginGUI.src.main;

import client.Client;
import client.loginGUI.src.component.PanelCover;
import client.loginGUI.src.component.PanelLoginAndRegister;
...
public class Main extends javax.swing.JFrame {
    ...
    private Client client; // Thêm biến Client
    ...
    private void init( Client client) {
        ...
        loginAndRegister = new PanelLoginAndRegister(client);
